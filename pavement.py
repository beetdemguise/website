...
from paver.easy import options, task, needs, consume_args  # noqa: E402
from paver.setuputils import install_distutils_tasks  # noqa: E402
...
def get_tasks():
    ...
    for env_task in environment.get_tasks():
        print(env_task.shortname)
