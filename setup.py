...
#
# However, when we do this, we also import `server/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'server_cli = server.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'server_gui = server.gui:entry_point'
        # ]
    }
)
